...
export const disenosDemo: Diseno[] = [
  { id: 1, servicioId: 1, nombre: 'Tarjeta Clásica', dimensiones: { ancho: 9, alto: 5, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 2, servicioId: 1, nombre: 'Tarjeta Moderna', dimensiones: { ancho: 9, alto: 5, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 3, servicioId: 1, nombre: 'Tarjeta Premium', dimensiones: { ancho: 9, alto: 5, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 4, servicioId: 2, nombre: 'Lanyard Básico', dimensiones: { ancho: 2, alto: 45, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 5, servicioId: 2, nombre: 'Lanyard Corporativo', dimensiones: { ancho: 2, alto: 45, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 6, servicioId: 3, nombre: 'Menú Restaurante', dimensiones: { ancho: 15, alto: 21, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 7, servicioId: 4, nombre: 'Fotocheck Básico', dimensiones: { ancho: 5.4, alto: 8.6, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 8, servicioId: 4, nombre: 'Fotocheck VIP', dimensiones: { ancho: 5.4, alto: 8.6, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 9, servicioId: 5, nombre: 'A4 Blanco', dimensiones: { ancho: 21, alto: 29.7, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 10, servicioId: 5, nombre: 'A3 Color', dimensiones: { ancho: 29.7, alto: 42, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 11, servicioId: 6, nombre: 'Tapa Dura', dimensiones: { ancho: 21, alto: 29.7, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 12, servicioId: 6, nombre: 'Tapa Blanda', dimensiones: { ancho: 21, alto: 29.7, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 13, servicioId: 9, nombre: 'Sello Redondo', dimensiones: { ancho: 4, alto: 4, unidad: 'cm' }, parametros: {}, activo: true },
  { id: 14, servicioId: 9, nombre: 'Sello Cuadrado', dimensiones: { ancho: 5, alto: 5, unidad: 'cm' }, parametros: {}, activo: true },
];

export const materialesDemo: Material[] = [
